/**
 * File   : variadic_function.c
 * Author : To Hoang Linh
 * Date   : 2019-04-23
 * ForWhat: Variadic Function (Hàm Phương Sai)
 ...
 * The declaration of a variadic function starts with the declaration of at least
 * one named variable, and uses an ellipsis (...) as the last parameter, e.g.
 *    int printf(const char* format, ...);
 * In this problem, you will implement three variadic functions named sum(),
 * min() and max() to calculate sums, minima, maxima of a variable number of
 * arguments. The first argument passed to the variadic function is the count
 * of the number of arguments, which is followed by the arguments themselves.
 */
