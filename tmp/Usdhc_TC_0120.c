...
*   Copyright 2018 NXP
*   ALL RIGHTS RESERVED.
*   @file Usdhc_TC_0120.c
*
*   @brief   Test case 0120.
*   @details Function test case 0120.
*
...
/*================================================================================================*/
/**
* @test_id        Usdhc_TC_0120
* @brief          Transfer (write cmd) a single block with block size not divisible by 4 using non-blocking.
* @details        This test case checks transfer (write cmd) a single block with block size not divisible by 4 using non-blocking.
* @pre            N/A
* @post           N/A
*
...
*                     -# Verification point:
*                        - uSDHC_DRV_Transfer function returns STATUS_ERROR
...
void Usdhc_TC_0120(void)
{
    ...
    content.data = &data;
    EU_ASSERT(STATUS_ERROR == uSDHC_DRV_Transfer(INST_USDHC1, &content));
