...
*   Copyright 2018 NXP
*   ALL RIGHTS RESERVED.
*   @file Usdhc_TC_0124.c
*
*   @brief   Test case 0124.
*   @details Function test case 0124.
*
...
/*================================================================================================*/
/**
* @test_id        Usdhc_TC_0124
* @brief          Transfer (write read cmd) multiple blocks with AutoCMD12 false using nonblocking.
...
*                     -# Verification point:
*                        - memory in multiple blocks should be NOT matched between read result and writing operation
...
void Usdhc_TC_0124(void)
{
    ...
    EU_ASSERT(0 != memcmp(g_dataRead, g_dataWrite, (T_uSDHC_MULTI_BLOCKS*DATA_DEFAULT_BLOCK_SIZE)));
