...
Begin VB.Form Form1 
   ...
   Begin VB.Frame Frame1 
      Caption         =   "S?? c? tr? h?쬗T?- Nh? 5 - T쬓1 - K49"
      BeginProperty Font 
         Name            =   ".VnTime"
         Size            =   14.25
         Charset         =   0
...
List1.AddItem "Th? gian ? ?nh Tod = " & Tod & " s"
    Else
  frmDoThi.Yod.Caption = "Yod=" & Format$(Yod, "##0.0##")
  frmDoThi.Yod.Move 8500, dtdy - Int((Yod + saiso * Yod) * ny)
  ...
  List1.AddItem "Th? gian ? ?nh Tod :  Hay Tang 'SO BUOC TINH'"
    End If
Else
    frmDoThi.Tod.Caption = " "
...
'In Ket qua
If OnDinh = True Then
List1.AddItem "Gi?tr?c? ?i Ymax = " & Ymax
List1.AddItem "Th? gian ?t c? ?i tmax = " & Tmax & " s"
List1.AddItem "Gi?tr?? ?nh Yod = " & Round(Yod, 0)
List1.AddItem "㏝ qu?췫? ch?h = " & Format$(Xichma, "##0.0##") & " %"
List1.AddItem " "
List1.AddItem "----------------------the Beginning Values-----------------------------------"
End If
List1.AddItem "100 Gi?tr?t?h to퇺, m? gi?tr?c퇭h nhau 10, l? "
List1.AddItem ""
For I = 1 To 100
