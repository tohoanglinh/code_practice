...
set(h,'linewidth',2.5);
xlabel('Time');
ylabel('Queuing delay (seconds)');
legend('CC-AQM:Simulation','CC-AQM:Theory','Single-Loop AQM','Location','best');
annote_x=[0.35 0.19];
annote_y=[0.85 0.77];
...
h1_leg=legend('Cascade-Loop:Simulation','Cascade-Loop:Theory','Single-Loop AQM','Location','south');
...
set(findall(gcf,'-property','FontSize'),'FontSize',16)
h2_leg=legend('Cascade-Loop:Simulation','Cascade-Loop:Theory','Single-Loop AQM','Location','south');
set(h1_leg, 'FontSize',12)
set(h2_leg, 'FontSize',12)
annote_x=[0.77 0.8];
annote_y=[0.75 0.82];
annotation('textarrow',annote_x,annote_y,'String','Cascade-Loop:Simulation-Pole','Color','b','FontSize',13)
annote_x=[0.74 0.71];
annote_y=[0.35 0.48];
annotation('textarrow',annote_x,annote_y,'String','Cascade-Loop:Theory-Pole','Color','k','FontSize',13)
annote_x=[0.66 0.685];
annote_y=[0.63 0.51];
annotation('textarrow',annote_x,annote_y,'String','Single-Loop:Pole','Color','r','FontSize',13)